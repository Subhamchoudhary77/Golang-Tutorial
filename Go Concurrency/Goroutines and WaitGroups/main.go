...
func main() {
	fmt.Println("Main Execution Started Here")
	...
	// 4.
	// Finally, we call wg.Wait()to block the execution of main() until the goroutines in the WaitGroup have successfully completed.
